...
- Фактическое по WakaTime - `41 ч 35 мин`

Т.е. на базовую часть ушло порядка 28-35 часов, остальное время - на доработку, рефакторинг и пробы новых для меня инструментов.
...
![kode-trainee-dev-languages](./src/images/wakatime-lang.jpg)